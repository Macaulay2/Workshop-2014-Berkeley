...
I = ideal"x4,xy3,y5"
apply( flatten entries gens I, m -> flatten exponents m)
apply(flatten entries basis(0,infinity, S/I), m -> flatten exponents m )
gens I
show new URL from {"file://"|PATH}
